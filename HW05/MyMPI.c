...
void read_checkerboard_matrix_square (
		char *s,              /* IN - File name */
		void ***subs,         /* OUT - 2D array */
		void **storage,       /* OUT - Array elements */
		MPI_Datatype dtype,   /* IN - Element type */
		int *n,               /* OUT - Array dimension */
...
void print_checkerboard_matrix_to_file (
		void       **a,            /* IN -2D matrix */
		MPI_Datatype dtype,        /* IN -Matrix element type */
		int          m,            /* IN -Matrix rows */
		int          n,            /* IN -Matrix columns */
		MPI_Comm     grid_comm,    /* IN - Communicator */
		char        *ofile)        /* IN - Output file name */
{
